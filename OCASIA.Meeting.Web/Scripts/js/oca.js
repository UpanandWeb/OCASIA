$(function() {
    ...
    var badge = $('.oca-nav .dropdown-toggle > .fa-bell + .badge')
    if ($(badge).length > 0 && parseInt($(badge).html()) > 0) {
        $('.oca-nav .dropdown-toggle > .fa-bell').addClass('anim-swing');
    }
    badge = $('.oca-nav .dropdown-toggle > .fa-envelope + .badge')
    if ($(badge).length > 0 && parseInt($(badge).html()) > 0) {
        $('.oca-nav .dropdown-toggle > .fa-envelope').addClass('anim-top-down');
    }
